...
#Use 'Dataset/Anne_of_Green_Gables.txt' for Transformers 1 and 2
#Use 'Dataset/tinychat.txt' for Transformer 3
...
#print(f"  Probe on random noise:               {random_cap_acc:.3f}")
#for layer_idx in range(len(model.blocks)):
#    print(f"  Probe on Layer {layer_idx} activations:        {cap_layer_accuracies[layer_idx]:.3f}")
...
print("\n" + "="*60)
print("SUMMARY: Which tasks did the model learn?")
print("="*60)

# Calculate improvements over base rate
